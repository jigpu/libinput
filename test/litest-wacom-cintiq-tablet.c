...
static struct input_event bad_distance_events[] = {
	{ .type = EV_ABS, .code = ABS_DISTANCE, .value = 0 },
	{ .type = EV_SYN, .code = SYN_REPORT, .value = 0 },
	{ .type = EV_ABS, .code = ABS_DISTANCE, .value = 63 },
	{ .type = EV_SYN, .code = SYN_REPORT, .value = 0 },
	{ .type = -1, .code = -1 },
};

static struct input_event normalization_min[] = {
...
static struct input_event normalization_max[] = {
	{ .type = EV_ABS, .code = ABS_PRESSURE, .value = 1024 },
	{ .type = EV_ABS, .code = ABS_TILT_X, .value = 128 },
	{ .type = EV_ABS, .code = ABS_TILT_Y, .value = 128 },
	{ .type = EV_SYN, .code = SYN_REPORT, .value = 0 },
	{ .type = -1, .code = -1 },
};
...
static struct litest_device_interface interface = {
	...
	.tablet_bad_distance_events = bad_distance_events,
	.tablet_normalization_min_events = normalization_min,
	.tablet_normalization_max_events = normalization_max,
};
